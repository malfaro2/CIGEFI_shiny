  ...
  function(input, output, session) {
    ...
    observeEvent(input$show_boxplot, {
      ...
      if(input$time == 'month'){
        ...
        filename4 = paste0('boxplot_monthly/','boxplot_' , unique(variable) ,'_', input$index,'_mes', number_of_month, '.png')
        ...
        filename4 = paste0('boxplot_yearly/' ,'boxplot_', unique(variable), '_', input$index, '_year.png')
        ...
        filename4 = paste0('boxplot_bimonthly/' ,'boxplot_', unique(variable), '_', input$index, '_bimonth_',input$option ,'.png')
    ...
    observeEvent(input$show_holvmoller, {
      ...
      if(input$variable == 'Temperature'){
        ...
        filename5 = paste0('hovmoller_temp/','index_', index_for_photo_holvmoller, '.png')
